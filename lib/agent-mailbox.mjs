...
function normalizeFallbackOutboundConfig(value) {
  ...
  return {
    ...
    apiKeyEnv: trimString(value.apiKeyEnv) || (normalizedProvider === 'resend_api' ? 'RESEND_API_KEY' : ''),
    apiBaseUrl: trimString(value.apiBaseUrl) || (normalizedProvider === 'resend_api' ? 'https://api.resend.com' : ''),
...
function normalizeOutboundConfig(value = {}) {
  ...
  return {
    ...
    workerTokenEnv: trimString(value.workerTokenEnv) || DEFAULT_OUTBOUND_CONFIG.workerTokenEnv,
    apiKey: trimString(value.apiKey),
    apiKeyEnv: trimString(value.apiKeyEnv) || (normalizedProvider === 'resend_api' ? 'RESEND_API_KEY' : DEFAULT_OUTBOUND_CONFIG.apiKeyEnv),
    apiBaseUrl: trimString(value.apiBaseUrl) || (normalizedProvider === 'resend_api' ? 'https://api.resend.com' : DEFAULT_OUTBOUND_CONFIG.apiBaseUrl),
    replyTo: trimString(value.replyTo),
