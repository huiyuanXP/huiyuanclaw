...
if (await pathExists(oldConfigDir) && !await pathExists(newConfigDir)) {
  try {
...
const configDir = await pathExists(newConfigDir)
  ? newConfigDir
  : (await pathExists(oldConfigDir) ? oldConfigDir : newConfigDir);
